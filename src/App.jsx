    ...
    <div className="bg-[#0f0c29] min-h-screen text-white overflow-hidden">
      ...
      <nav className="flex justify-between items-center px-8 md:px-16 py-6 fixed w-full top-0 z-50 bg-[#0f0c29]/80 backdrop-blur-md border-b border-cyan-500/10">
        ...
        <ul className="hidden md:flex gap-10 text-lg text-gray-300">
          ...
          <li>
            <a href="#home" className="hover:text-purple-400 cursor-pointer transition">
              Home
            </a>
          </li>

          <li>
            <a href="#about" className="hover:text-purple-400 cursor-pointer transition">
              About
            </a>
          </li>

          <li>
            <a href="#skills" className="hover:text-purple-400 cursor-pointer transition">
              Skills
            </a>
          </li>

          <li>
            <a href="#projects" className="hover:text-purple-400 cursor-pointer transition">
              Projects
            </a>
          </li>

          <li>
            <a href="#contact" className="hover:text-purple-400 cursor-pointer transition">
              Contact
            </a>
          </li>
      ...
      <section
        id="home"
        className="flex flex-col justify-center items-center text-center h-screen px-6 relative"
      >
